...
<div class="container-fluid">
		<div id="header-add" class="addvertise"></div>
		<div class="row" style="margin-top: 5px;">
			<div class="col-md-9 col-sm-12"><tiles:insertAttribute name="body"/></div>
			<div class="col-md-3 d-none d-sm-block"><tiles:insertAttribute name="links" /></div>
		</div>
</div>
<div id="footer-add" class="addvertise"></div>
