...
<div class="modal fade loginRegModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog cascading-modal" role="document">
		...
		<div class="modal-body">
			...
			<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: relative;margin-top: -46px;">
	          <span aria-hidden="true">&times;</span>
	        </button>
	<!-- Tab panes -->
			...
			<div class="cid-rZyx54TTym" id="social-buttons3-25" >
				<div class="row">
					<div class="col-md-12 align-center">
				 <span class="btn btn-social socicon-bg-facebook facebook mx-2" title="Login using Facebook">
				      <a href="<c:url value='/auth/login/facebook'/>" class="ssoLogin text-white"><i class="socicon socicon-facebook"></i></a>
				 </span>
				 <span class="btn btn-social googleplus socicon-bg-googleplus mx-2" title="Login using Google">
				     <a href="<c:url value='/auth/login/google'/>" class="ssoLogin text-white"><i class="socicon socicon-googleplus"></i></a> 
				 </span>
				 <span class="btn btn-social socicon-bg-github mx-2" title="Login using Github">
				     <a href="<c:url value='/auth/login/github'/>" class="ssoLogin"><i class="socicon socicon-github"></i></a> 
				 </span>
				<span class="btn btn-social twitter socicon-bg-twitter mx-2" title="Login using Twitter">
				     <a href="<c:url value='/auth/login/twitter'/>" class="ssoLogin text-white"><i class="socicon socicon-twitter"></i></a>
				 </span>
			</div>	
				</div>
			</div>
...
<button id="forpasswodr" name="forpassword" class="btn btn-primary btn-block">Send</button>
  ...
  <script src='<c:url value="/views/assets/sociallikes/social-likes.js"/>'></script>
